...
image:https://github.com/melix/japicmp-gradle-plugin/actions/workflows/main.yml/badge.svg?branch=master&event=push["Build Status", link="https://github.com/melix/japicmp-gradle-plugin/actions/workflows/main.yml?query=branch:master+event:push"]
